...
// Redirecciones si ya tiene sesión
                    ...
                    <form id="public-calculator-form" novalidate>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                <span class="input-group-text bg-light fw-bold" id="label-moneda-origen">CLP</span>
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-6 transition-all" id="col-monto-destino">
                                ...
                                <div class="input-group">
                                    ...
                                    <span class="input-group-text bg-success text-white fw-bold"
                                        id="label-moneda-destino">...</span>
                                </div>
                            </div>

                            <div class="col-6 transition-all" id="col-monto-usd">
                        ...
                        <div class="text-center mt-3">
                            <small class="text-muted"><i class="bi bi-info-circle"></i> Regístrate para concretar tu envío.</small>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <section class="row text-center g-4">
        <div class="col-md-4">
            <div class="p-4 rounded-3 bg-white shadow-sm h-100 border-bottom border-primary border-4">
                ...
                <p class="text-muted">Tus datos y dinero protegidos con cifrado de grado bancario.</p>
            </div>
        </div>
        <div class="col-md-4">
            <div class="p-4 rounded-3 bg-white shadow-sm h-100 border-bottom border-success border-4">
                ...
                <p class="text-muted">El dinero llega a su destino en poco tiempo una vez confirmado.</p>
            </div>
        </div>
        <div class="col-md-4">
            <div class="p-4 rounded-3 bg-white shadow-sm h-100 border-bottom border-info border-4">
                ...
                <p class="text-muted">Atención personalizada por WhatsApp para resolver tus dudas.</p>
            </div>
        </div>
    </section>
