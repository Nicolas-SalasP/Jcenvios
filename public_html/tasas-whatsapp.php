...
$stmt = $db->prepare("SELECT RutaImagen, FechaActualizacion FROM tasas_imagen WHERE TipoFuente = 'whatsapp' LIMIT 1");
$stmt->execute();
...
$imagenUrl = $imagenDisponible ? (rtrim(BASE_URL, '/') . '/tasas_imagen_stream.php?tipo=whatsapp&v=' . $version) : null;
?>
<!DOCTYPE html>
<html lang="es">
<head>
